...
#define INCLUDED_FlxUIDropDownHeader
...
class HXCPP_CLASS_ATTRIBUTES FlxUIDropDownHeader_obj : public  ::flixel::addons::ui::FlxUIGroup_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="FlxUIDropDownHeader")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"FlxUIDropDownHeader"); }
...
#endif /* INCLUDED_FlxUIDropDownHeader */ 
