...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String modsShaderFragment(::String key,::String library);
		static ::Dynamic modsShaderFragment_dyn();

		static ::String modsShaderVertex(::String key,::String library);
		static ::Dynamic modsShaderVertex_dyn();
