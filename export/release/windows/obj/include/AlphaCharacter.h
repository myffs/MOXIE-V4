...
class HXCPP_CLASS_ATTRIBUTES AlphaCharacter_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float x,Float y,Float textSize);
		...
		static ::hx::ObjectPtr< AlphaCharacter_obj > __new(Float x,Float y,Float textSize);
		static ::hx::ObjectPtr< AlphaCharacter_obj > __alloc(::hx::Ctx *_hx_ctx,Float x,Float y,Float textSize);
		...
		int row;
		Float textSize;
		void createBoldLetter(::String letter);
		::Dynamic createBoldLetter_dyn();

		void createBoldNumber(::String letter);
		::Dynamic createBoldNumber_dyn();

		void createBoldSymbol(::String letter);
		::Dynamic createBoldSymbol_dyn();
