...
HXDLIN( 106)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("achievementgrid",b5,fa,02,8a),library);
HXDLIN( 106)			this->loadGraphic(returnAsset,true,150,150,null(),null());
HXLINE( 107)			 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
HXDLIN( 107)			_hx_tmp->add(HX_("icon",79,e7,b2,45),::Array_obj< int >::__new(1)->init(0,::Achievements_obj::getAchievementIndex(this->tag)),0,false,false,null());
HXLINE( 108)			this->animation->play(HX_("icon",79,e7,b2,45),null(),null(),null());
            		}
            		else {
HXLINE( 110)			::String library = null();
HXDLIN( 110)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("lockedachievement",a5,23,f4,2a),library);
HXDLIN( 110)			this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
            		}
