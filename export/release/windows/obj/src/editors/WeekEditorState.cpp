...
HXLINE( 150)		{
HXLINE( 150)			 ::flixel::util::FlxAxes axes1 = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 150)			if (::hx::IsNull( axes1 )) {
HXLINE( 150)				axes1 = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 150)			bool _hx_tmp6;
HXDLIN( 150)			switch((int)(axes1->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXLINE( 156)		{
HXLINE( 156)			 ::flixel::util::FlxAxes axes2 = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 156)			if (::hx::IsNull( axes2 )) {
HXLINE( 156)				axes2 = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 156)			bool _hx_tmp8;
HXDLIN( 156)			switch((int)(axes2->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXDLIN( 322)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 322)			if (::hx::IsNull( axes )) {
HXLINE( 322)				axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 322)			bool _hx_tmp1;
HXDLIN( 322)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXDLIN( 461)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 461)			if (::hx::IsNull( axes )) {
HXLINE( 461)				axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 461)			bool _hx_tmp;
HXDLIN( 461)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
