...
HX_LOCAL_STACK_FRAME(_hx_pos_0d30d54fdd7b0ca4_85_onChangeAntiAliasing,"options.GraphicsSettingsSubState","onChangeAntiAliasing",0x62f8a1e2,"options.GraphicsSettingsSubState.onChangeAntiAliasing","options/GraphicsSettingsSubState.hx",85,0x60b97b2e)
HX_LOCAL_STACK_FRAME(_hx_pos_0d30d54fdd7b0ca4_97_onChangeFramerate,"options.GraphicsSettingsSubState","onChangeFramerate",0x9c8ce9ff,"options.GraphicsSettingsSubState.onChangeFramerate","options/GraphicsSettingsSubState.hx",97,0x60b97b2e)
namespace options{
...
HXLINE(  57)		 ::options::Option option2 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Framerate",6d,c5,1e,f0),HX_("Pretty self explanatory, isn't it?",b4,ed,8b,6f),HX_("framerate",8d,e5,4b,4e),HX_("int",ef,0c,50,00),60,null());
HXLINE(  62)		this->addOption(option2);
HXLINE(  64)		option2->minValue = 60;
HXLINE(  65)		option2->maxValue = 240;
HXLINE(  66)		option2->displayFormat = HX_("%v FPS",da,04,d9,d1);
HXLINE(  67)		option2->onChange = this->onChangeFramerate_dyn();
...
void GraphicsSettingsSubState_obj::onChangeAntiAliasing(){
            	HX_STACKFRAME(&_hx_pos_0d30d54fdd7b0ca4_85_onChangeAntiAliasing)
HXDLIN(  85)		int _g = 0;
HXDLIN(  85)		::Array< ::Dynamic> _g1 = this->members;
HXDLIN(  85)		while((_g < _g1->length)){
HXDLIN(  85)			 ::flixel::FlxBasic sprite = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  85)			_g = (_g + 1);
HXLINE(  87)			 ::Dynamic sprite1 = sprite;
HXLINE(  88)			 ::flixel::FlxSprite sprite2 = ( ( ::flixel::FlxSprite)(sprite1) );
HXLINE(  89)			bool _hx_tmp;
HXDLIN(  89)			bool _hx_tmp1;
HXDLIN(  89)			if (::hx::IsNotNull( sprite2 )) {
HXLINE(  89)				_hx_tmp1 = ::Std_obj::isOfType(sprite2,::hx::ClassOf< ::flixel::FlxSprite >());
            			}
            			else {
HXLINE(  89)				_hx_tmp1 = false;
            			}
HXDLIN(  89)			if (_hx_tmp1) {
HXLINE(  89)				_hx_tmp = !(::Std_obj::isOfType(sprite2,::hx::ClassOf< ::flixel::text::FlxText >()));
            			}
            			else {
HXLINE(  89)				_hx_tmp = false;
            			}
HXDLIN(  89)			if (_hx_tmp) {
HXLINE(  90)				sprite2->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            			}
            		}
            	}
...
void GraphicsSettingsSubState_obj::onChangeFramerate(){
            	HX_STACKFRAME(&_hx_pos_0d30d54fdd7b0ca4_97_onChangeFramerate)
HXDLIN(  97)		if ((::ClientPrefs_obj::framerate > ::flixel::FlxG_obj::drawFramerate)) {
HXLINE(  99)			::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
HXLINE( 100)			::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
            		}
            		else {
HXLINE( 104)			::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
HXLINE( 105)			::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
            		}
            	}
