...
HXLINE(  59)		bg1->set_color(-2039584);
HXLINE(  60)		{
...
HXLINE(  78)		 ::Alphabet titleText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),this->title,true,false,0,((Float)0.6));
HXLINE(  79)		titleText->set_x((titleText->x + 60));
HXLINE(  80)		titleText->set_y((titleText->y + 40));
...
HXLINE(  92)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)((70 * i)) ),this->optionsArray->__get(i).StaticCast<  ::options::Option >()->name,false,false,null(),null());
HXLINE(  93)				optionText->isMenuItem = true;
HXLINE(  94)				optionText->set_x((optionText->x + 300));
HXLINE(  97)				optionText->xAdd = ( (Float)(200) );
HXLINE(  98)				optionText->targetY = ( (Float)(i) );
...
HXLINE( 108)					 ::Alphabet optionText1 = optionText;
HXDLIN( 108)					optionText1->xAdd = (optionText1->xAdd - ( (Float)(80) ));
...
HXDLIN( 297)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::Y_dyn();
HXDLIN( 297)			if (::hx::IsNull( axes )) {
HXLINE( 297)				axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 297)			bool _hx_tmp1;
HXDLIN( 297)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXDLIN( 302)				_g = (_g + 1);
HXLINE( 303)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
