...
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_116_onChangePauseMusic,"options.VisualsUISubState","onChangePauseMusic",0xdfdbfe24,"options.VisualsUISubState.onChangePauseMusic","options/VisualsUISubState.hx",116,0x3f30f917)
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_126_destroy,"options.VisualsUISubState","destroy",0x298befb4,"options.VisualsUISubState.destroy","options/VisualsUISubState.hx",126,0x3f30f917)
HX_LOCAL_STACK_FRAME(_hx_pos_4e14480e50e84747_134_onChangeFPSCounter,"options.VisualsUISubState","onChangeFPSCounter",0xf92afa68,"options.VisualsUISubState.onChangeFPSCounter","options/VisualsUISubState.hx",134,0x3f30f917)
namespace options{

void VisualsUISubState_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4e14480e50e84747_30_new)
HXLINE( 114)		this->changedMusic = false;
...
void VisualsUISubState_obj::onChangePauseMusic(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_116_onChangePauseMusic)
HXLINE( 117)		if ((::ClientPrefs_obj::pauseMusic == HX_("None",d8,3e,e3,33))) {
HXLINE( 118)			::flixel::FlxG_obj::sound->music->set_volume(( (Float)(0) ));
            		}
            		else {
HXLINE( 120)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 120)			::String library = null();
HXDLIN( 120)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),::StringTools_obj::replace(::ClientPrefs_obj::pauseMusic.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)),library);
HXDLIN( 120)			_hx_tmp->playMusic(file,null(),null(),null());
            		}
HXLINE( 122)		this->changedMusic = true;
            	}
...
void VisualsUISubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_126_destroy)
HXLINE( 127)		if (this->changedMusic) {
HXLINE( 127)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 127)			::String library = null();
HXDLIN( 127)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 127)			_hx_tmp->playMusic(file,null(),null(),null());
            		}
...
void VisualsUISubState_obj::onChangeFPSCounter(){
            	HX_STACKFRAME(&_hx_pos_4e14480e50e84747_134_onChangeFPSCounter)
HXDLIN( 134)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
