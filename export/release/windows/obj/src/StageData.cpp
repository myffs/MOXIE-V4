...
HX_LOCAL_STACK_FRAME(_hx_pos_60a8bb2029d84628_69_getStageFile,"StageData","getStageFile",0xd040712a,"StageData.getStageFile","StageData.hx",69,0xe1269fd6)
...
HXDLIN(  49)					goto _hx_goto_0;
            				...
            				/* default */{
HXLINE(  55)					stage = HX_("stage",be,6a,0b,84);
            				}
            				_hx_goto_0:;
            			}
            			else {
...
HXLINE(  61)		 ::Dynamic stageFile = ::StageData_obj::getStageFile(stage);
HXLINE(  62)		if (::hx::IsNull( stageFile )) {
HXLINE(  63)			::StageData_obj::forceNextDirectory = HX_("",00,00,00,00);
            		}
            		else {
HXLINE(  65)			::StageData_obj::forceNextDirectory = ( (::String)(stageFile->__Field(HX_("directory",6d,f2,44,10),::hx::paccDynamic)) );
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(StageData_obj,loadDirectory,(void))
 ...
 ::Dynamic StageData_obj::getStageFile(::String stage){
            	HX_GC_STACKFRAME(&_hx_pos_60a8bb2029d84628_69_getStageFile)
HXLINE(  70)		::String rawJson = null();
HXLINE(  71)		::String file = ((HX_("stages/",9a,7a,ca,2d) + stage) + HX_(".json",56,f1,d6,c2));
HXDLIN(  71)		if (::hx::IsNull( file )) {
HXLINE(  71)			file = HX_("",00,00,00,00);
            		}
HXDLIN(  71)		::String path = (HX_("assets/",4c,2a,dc,36) + file);
HXLINE(  74)		::String modPath = ::Paths_obj::modFolders(((HX_("stages/",9a,7a,ca,2d) + stage) + HX_(".json",56,f1,d6,c2)));
HXLINE(  75)		if (::sys::FileSystem_obj::exists(modPath)) {
HXLINE(  76)			rawJson = ::sys::io::File_obj::getContent(modPath);
            		}
            		else {
HXLINE(  77)			if (::sys::FileSystem_obj::exists(path)) {
HXLINE(  78)				rawJson = ::sys::io::File_obj::getContent(path);
            			}
            			else {
HXLINE(  87)				return null();
            			}
            		}
HXLINE(  89)		return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
            	}
