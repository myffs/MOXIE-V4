...
HXLINE(  19)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("1114758804236664923",16,3e,04,5f))
...
HXDLIN(  44)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Vs. Moxie",e3,30,9e,72))));
            	}
...
HXLINE(  85)		::String _hx_tmp = (HX_("Vs. Moxie  ",a3,8b,36,fb) + ::MainMenuState_obj::psychEngineVersion);
