...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_241_reloadNote,"Note","reloadNote",0x1599eec7,"Note.reloadNote","Note.hx",241,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_312_loadNoteAnims,"Note","loadNoteAnims",0x493f5f8e,"Note.loadNoteAnims","Note.hx",312,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_336_loadPixelNoteAnims,"Note","loadPixelNoteAnims",0xefd7042c,"Note.loadPixelNoteAnims","Note.hx",336,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_355_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",355,0x1a8855ec)
...
HXLINE( 240)		this->originalHeightForCalcs = ((Float)6);
HXLINE( 239)		this->lastNoteScaleToo = ((Float)1);
HXLINE( 238)		this->lastNoteOffsetXForPixelAutoAdjusting = ((Float)0);
...
HXLINE( 129)		super::__construct(null(),null(),null());
HXLINE( 131)		if (::hx::IsNull( prevNote )) {
HXLINE( 132)			prevNote = ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 134)		this->prevNote = prevNote;
HXLINE( 135)		this->isSustainNote = ( (bool)(sustainNote) );
HXLINE( 136)		this->inEditor = ( (bool)(inEditor) );
HXLINE( 138)		int _hx_tmp;
HXDLIN( 138)		if (::ClientPrefs_obj::middleScroll) {
HXLINE( 138)			_hx_tmp = ::PlayState_obj::STRUM_X_MIDDLESCROLL;
            		}
            		else {
HXLINE( 138)			_hx_tmp = ::PlayState_obj::STRUM_X;
            		}
HXDLIN( 138)		this->set_x((this->x + (_hx_tmp + 50)));
HXLINE( 140)		this->set_y((this->y - ( (Float)(2000) )));
HXLINE( 141)		this->strumTime = strumTime;
HXLINE( 142)		if (!(( (bool)(inEditor) ))) {
HXLINE( 142)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 142)			_hx_tmp->strumTime = (_hx_tmp->strumTime + ::ClientPrefs_obj::noteOffset);
            		}
HXLINE( 144)		this->noteData = noteData;
HXLINE( 146)		if ((noteData > -1)) {
HXLINE( 147)			this->set_texture(HX_("",00,00,00,00));
HXLINE( 148)			this->colorSwap =  ::ColorSwap_obj::__alloc( HX_CTX );
HXLINE( 149)			this->shader = this->colorSwap->shader;
HXLINE( 151)			this->set_x((this->x + (::Note_obj::swagWidth * ( (Float)(::hx::Mod(noteData,4)) ))));
HXLINE( 152)			if (!(this->isSustainNote)) {
HXLINE( 153)				::String animToPlay = HX_("",00,00,00,00);
HXLINE( 154)				switch((int)(::hx::Mod(noteData,4))){
            					case (int)0: {
HXLINE( 157)						animToPlay = HX_("purple",3c,f6,89,71);
            					}
            					break;
            					case (int)1: {
HXLINE( 159)						animToPlay = HX_("blue",9a,42,19,41);
            					}
            					break;
            					case (int)2: {
HXLINE( 161)						animToPlay = HX_("green",c3,0e,ed,99);
            					}
            					break;
            					case (int)3: {
HXLINE( 163)						animToPlay = HX_("red",51,d9,56,00);
            					}
            					break;
            				}
HXLINE( 165)				this->animation->play((animToPlay + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
            			}
            		}
HXLINE( 171)		bool _hx_tmp1;
HXDLIN( 171)		if (this->isSustainNote) {
HXLINE( 171)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
...
HXLINE( 174)			this->multAlpha = ((Float)0.6);
HXLINE( 175)			this->hitsoundDisabled = true;
HXLINE( 176)			if (::ClientPrefs_obj::downScroll) {
HXLINE( 176)				this->set_flipY(true);
            			}
HXLINE( 178)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 178)			Float _hx_tmp1 = _hx_tmp->offsetX;
HXDLIN( 178)			_hx_tmp->offsetX = (_hx_tmp1 + (this->get_width() / ( (Float)(2) )));
HXLINE( 179)			this->copyAngle = false;
HXLINE( 181)			switch((int)(noteData)){
            				case (int)0: {
HXLINE( 184)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				}
            				break;
            				case (int)1: {
HXLINE( 186)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				}
            				break;
            				case (int)2: {
...
HXLINE( 195)			 ::Note _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 195)			Float _hx_tmp3 = _hx_tmp2->offsetX;
HXDLIN( 195)			_hx_tmp2->offsetX = (_hx_tmp3 - (this->get_width() / ( (Float)(2) )));
HXLINE( 197)			if (::PlayState_obj::isPixelStage) {
HXLINE( 198)				 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 198)				_hx_tmp->offsetX = (_hx_tmp->offsetX + 30);
            			}
HXLINE( 200)			if (prevNote->isSustainNote) {
HXLINE( 202)				switch((int)(prevNote->noteData)){
            					case (int)0: {
HXLINE( 205)						prevNote->animation->play(HX_("purplehold",7b,8d,da,cd),null(),null(),null());
            					}
            					break;
            					case (int)1: {
HXLINE( 207)						prevNote->animation->play(HX_("bluehold",d9,60,aa,a4),null(),null(),null());
            					}
            					break;
            					case (int)2: {
HXLINE( 209)						prevNote->animation->play(HX_("greenhold",82,f5,c1,bc),null(),null(),null());
            					}
            					break;
            					case (int)3: {
HXLINE( 211)						prevNote->animation->play(HX_("redhold",10,1f,bf,bf),null(),null(),null());
            					}
            					break;
            				}
HXLINE( 214)				 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 214)				fh->set_y((fh->y * ((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05))));
HXLINE( 215)				if (::hx::IsNotNull( ::PlayState_obj::instance )) {
HXLINE( 217)					 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 217)					fh->set_y((fh->y * ::PlayState_obj::instance->songSpeed));
            				}
HXLINE( 220)				if (::PlayState_obj::isPixelStage) {
HXLINE( 221)					 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 221)					fh->set_y((fh->y * ((Float)1.19)));
HXLINE( 222)					 ::flixel::math::FlxPoint fh1 = prevNote->scale;
HXDLIN( 222)					Float fh2 = fh1->y;
HXDLIN( 222)					fh1->set_y((fh2 * (( (Float)(6) ) / this->get_height())));
            				}
...
HXDLIN( 115)				goto _hx_goto_2;
            			...
            			_hx_goto_2:;
HXLINE( 119)			this->noteType = value;
            		}
HXLINE( 121)		this->noteSplashHue = this->colorSwap->hue;
HXLINE( 122)		this->noteSplashSat = this->colorSwap->saturation;
HXLINE( 123)		this->noteSplashBrt = this->colorSwap->brightness;
...
void Note_obj::reloadNote(::String __o_prefix,::String __o_texture,::String __o_suffix){
            	...
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_241_reloadNote)
HXLINE( 242)		if (::hx::IsNull( prefix )) {
HXLINE( 242)			prefix = HX_("",00,00,00,00);
            		}
HXLINE( 243)		if (::hx::IsNull( texture )) {
HXLINE( 243)			texture = HX_("",00,00,00,00);
            		}
HXLINE( 244)		if (::hx::IsNull( suffix )) {
HXLINE( 244)			suffix = HX_("",00,00,00,00);
            		}
HXLINE( 246)		::String skin = texture;
HXLINE( 247)		if ((texture.length < 1)) {
HXLINE( 248)			skin = ( (::String)(::PlayState_obj::SONG->__Field(HX_("arrowSkin",e6,d4,f8,07),::hx::paccDynamic)) );
HXLINE( 249)			bool _hx_tmp;
HXDLIN( 249)			if (::hx::IsNotNull( skin )) {
HXLINE( 249)				_hx_tmp = (skin.length < 1);
            			}
            			else {
HXLINE( 249)				_hx_tmp = true;
            			}
HXDLIN( 249)			if (_hx_tmp) {
HXLINE( 250)				skin = HX_("NOTE_assets",70,3c,09,f7);
            			}
            		}
HXLINE( 254)		::String animName = null();
HXLINE( 255)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 256)			animName = this->animation->_curAnim->name;
            		}
HXLINE( 259)		::Array< ::String > arraySkin = skin.split(HX_("/",2f,00,00,00));
HXLINE( 260)		arraySkin[(arraySkin->length - 1)] = ((prefix + arraySkin->__get((arraySkin->length - 1))) + suffix);
HXLINE( 262)		Float lastScaleY = this->scale->y;
HXLINE( 263)		::String blahblah = arraySkin->join(HX_("/",2f,00,00,00));
HXLINE( 264)		if (::PlayState_obj::isPixelStage) {
HXLINE( 265)			if (this->isSustainNote) {
HXLINE( 266)				::String library = null();
HXDLIN( 266)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d)),library);
HXDLIN( 266)				this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 267)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 268)				this->set_height((this->get_height() / ( (Float)(2) )));
HXLINE( 269)				this->originalHeightForCalcs = this->get_height();
HXLINE( 270)				::String library1 = null();
HXDLIN( 270)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d)),library1);
HXDLIN( 270)				int _hx_tmp = ::Math_obj::floor(this->get_width());
HXDLIN( 270)				this->loadGraphic(returnAsset1,true,_hx_tmp,::Math_obj::floor(this->get_height()),null(),null());
            			}
            			else {
HXLINE( 272)				::String library = null();
HXDLIN( 272)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library);
HXDLIN( 272)				this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 273)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 274)				this->set_height((this->get_height() / ( (Float)(5) )));
HXLINE( 275)				::String library1 = null();
HXDLIN( 275)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library1);
HXDLIN( 275)				int _hx_tmp = ::Math_obj::floor(this->get_width());
HXDLIN( 275)				this->loadGraphic(returnAsset1,true,_hx_tmp,::Math_obj::floor(this->get_height()),null(),null());
            			}
HXLINE( 277)			Float _hx_tmp = this->get_width();
HXDLIN( 277)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
HXLINE( 278)			this->loadPixelNoteAnims();
HXLINE( 279)			this->set_antialiasing(false);
HXLINE( 281)			if (this->isSustainNote) {
HXLINE( 282)				 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 282)				_hx_tmp->offsetX = (_hx_tmp->offsetX + this->lastNoteOffsetXForPixelAutoAdjusting);
HXLINE( 283)				Float _hx_tmp1 = (this->get_width() - ( (Float)(7) ));
HXDLIN( 283)				this->lastNoteOffsetXForPixelAutoAdjusting = (_hx_tmp1 * (::PlayState_obj::daPixelZoom / ( (Float)(2) )));
HXLINE( 284)				 ::Note _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 284)				_hx_tmp2->offsetX = (_hx_tmp2->offsetX - this->lastNoteOffsetXForPixelAutoAdjusting);
            			}
            		}
            		else {
HXLINE( 294)			::String library = null();
HXDLIN( 294)			 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(blahblah,null());
HXDLIN( 294)			bool xmlExists = false;
HXDLIN( 294)			if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 294)				xmlExists = true;
            			}
HXDLIN( 294)			 ::Dynamic _hx_tmp;
HXDLIN( 294)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 294)				_hx_tmp = imageLoaded;
            			}
            			else {
HXLINE( 294)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(blahblah,library);
HXDLIN( 294)				_hx_tmp = returnAsset;
            			}
HXDLIN( 294)			::String _hx_tmp1;
HXDLIN( 294)			if (xmlExists) {
HXLINE( 294)				_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE( 294)				_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            			}
HXDLIN( 294)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 295)			this->loadNoteAnims();
HXLINE( 296)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            		}
HXLINE( 298)		if (this->isSustainNote) {
HXLINE( 299)			this->scale->set_y(lastScaleY);
            		}
HXLINE( 301)		this->updateHitbox();
HXLINE( 303)		if (::hx::IsNotNull( animName )) {
HXLINE( 304)			this->animation->play(animName,true,null(),null());
            		}
HXLINE( 306)		if (this->inEditor) {
HXLINE( 307)			this->setGraphicSize(::editors::ChartingState_obj::GRID_SIZE,::editors::ChartingState_obj::GRID_SIZE);
HXLINE( 308)			this->updateHitbox();
            		}
            	}
...
void Note_obj::loadNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_312_loadNoteAnims)
HXLINE( 313)		this->animation->addByPrefix(HX_("greenScroll",30,4f,fe,9e),HX_("green0",0d,dc,7f,15),null(),null(),null(),null());
HXLINE( 314)		this->animation->addByPrefix(HX_("redScroll",3e,78,c3,3a),HX_("red0",bf,4d,a7,4b),null(),null(),null(),null());
HXLINE( 315)		this->animation->addByPrefix(HX_("blueScroll",47,7e,59,a2),HX_("blue0",56,04,01,b5),null(),null(),null(),null());
HXLINE( 316)		this->animation->addByPrefix(HX_("purpleScroll",69,97,67,99),HX_("purple0",74,7e,2d,e7),null(),null(),null(),null());
HXLINE( 318)		if (this->isSustainNote) {
HXLINE( 320)			this->animation->addByPrefix(HX_("purpleholdend",40,d5,15,5b),HX_("pruple end hold",6e,7c,17,3a),null(),null(),null(),null());
HXLINE( 321)			this->animation->addByPrefix(HX_("greenholdend",99,eb,5f,39),HX_("green hold end",77,4d,45,46),null(),null(),null(),null());
HXLINE( 322)			this->animation->addByPrefix(HX_("redholdend",cb,ae,1e,ea),HX_("red hold end",29,c1,a0,b6),null(),null(),null(),null());
HXLINE( 323)			this->animation->addByPrefix(HX_("blueholdend",a2,f0,cd,25),HX_("blue hold end",c0,66,05,ae),null(),null(),null(),null());
HXLINE( 325)			this->animation->addByPrefix(HX_("purplehold",7b,8d,da,cd),HX_("purple hold piece",b1,8b,b1,d3),null(),null(),null(),null());
HXLINE( 326)			this->animation->addByPrefix(HX_("greenhold",82,f5,c1,bc),HX_("green hold piece",8a,42,68,ae),null(),null(),null(),null());
HXLINE( 327)			this->animation->addByPrefix(HX_("redhold",10,1f,bf,bf),HX_("red hold piece",bc,86,4d,83),null(),null(),null(),null());
HXLINE( 328)			this->animation->addByPrefix(HX_("bluehold",d9,60,aa,a4),HX_("blue hold piece",13,00,58,99),null(),null(),null(),null());
            		}
HXLINE( 331)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
...
void Note_obj::loadPixelNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_336_loadPixelNoteAnims)
HXDLIN( 336)		if (this->isSustainNote) {
HXLINE( 337)			this->animation->add(HX_("purpleholdend",40,d5,15,5b),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
HXLINE( 338)			this->animation->add(HX_("greenholdend",99,eb,5f,39),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 339)			this->animation->add(HX_("redholdend",cb,ae,1e,ea),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 340)			this->animation->add(HX_("blueholdend",a2,f0,cd,25),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 342)			this->animation->add(HX_("purplehold",7b,8d,da,cd),::Array_obj< int >::__new(1)->init(0,::Note_obj::PURP_NOTE),null(),null(),null(),null());
HXLINE( 343)			this->animation->add(HX_("greenhold",82,f5,c1,bc),::Array_obj< int >::__new(1)->init(0,::Note_obj::GREEN_NOTE),null(),null(),null(),null());
HXLINE( 344)			this->animation->add(HX_("redhold",10,1f,bf,bf),::Array_obj< int >::__new(1)->init(0,::Note_obj::RED_NOTE),null(),null(),null(),null());
HXLINE( 345)			this->animation->add(HX_("bluehold",d9,60,aa,a4),::Array_obj< int >::__new(1)->init(0,::Note_obj::BLUE_NOTE),null(),null(),null(),null());
            		}
            		else {
HXLINE( 347)			this->animation->add(HX_("greenScroll",30,4f,fe,9e),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 348)			this->animation->add(HX_("redScroll",3e,78,c3,3a),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 349)			this->animation->add(HX_("blueScroll",47,7e,59,a2),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 350)			this->animation->add(HX_("purpleScroll",69,97,67,99),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_355_update)
HXLINE( 356)		this->super::update(elapsed);
HXLINE( 358)		if (this->mustPress) {
HXLINE( 361)			bool _hx_tmp;
HXDLIN( 361)			if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 361)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)));
            			}
            			else {
HXLINE( 361)				_hx_tmp = false;
            			}
HXDLIN( 361)			if (_hx_tmp) {
HXLINE( 363)				this->canBeHit = true;
            			}
            			else {
HXLINE( 365)				this->canBeHit = false;
            			}
HXLINE( 367)			bool _hx_tmp1;
HXDLIN( 367)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 367)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 367)				_hx_tmp1 = false;
            			}
HXDLIN( 367)			if (_hx_tmp1) {
HXLINE( 368)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 372)			this->canBeHit = false;
HXLINE( 374)			if ((this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)))) {
HXLINE( 376)				bool _hx_tmp;
HXDLIN( 376)				bool _hx_tmp1;
HXDLIN( 376)				if (this->isSustainNote) {
HXLINE( 376)					_hx_tmp1 = this->prevNote->wasGoodHit;
            				}
            				else {
HXLINE( 376)					_hx_tmp1 = false;
            				}
HXDLIN( 376)				if (!(_hx_tmp1)) {
HXLINE( 376)					_hx_tmp = (this->strumTime <= ::Conductor_obj::songPosition);
            				}
            				else {
HXLINE( 376)					_hx_tmp = true;
            				}
HXDLIN( 376)				if (_hx_tmp) {
HXLINE( 377)					this->wasGoodHit = true;
            				}
            			}
            		}
HXLINE( 381)		bool _hx_tmp;
HXDLIN( 381)		if (this->tooLate) {
HXLINE( 381)			_hx_tmp = !(this->inEditor);
            		}
            		else {
HXLINE( 381)			_hx_tmp = false;
            		}
HXDLIN( 381)		if (_hx_tmp) {
HXLINE( 383)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 384)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
