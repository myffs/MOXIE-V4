...
::FlxUIDropDownMenuDropDirection FlxUIDropDownMenuDropDirection_obj::Automatic;

::FlxUIDropDownMenuDropDirection FlxUIDropDownMenuDropDirection_obj::Down;

::FlxUIDropDownMenuDropDirection FlxUIDropDownMenuDropDirection_obj::Up;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("FlxUIDropDownMenuDropDirection",7a,77,67,00), ::hx::TCanCast< FlxUIDropDownMenuDropDirection_obj >,FlxUIDropDownMenuDropDirection_obj_sStaticFields,0,
