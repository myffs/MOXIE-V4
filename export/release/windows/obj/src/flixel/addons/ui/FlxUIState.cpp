...
HXDLIN( 156)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 152)						if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE( 156)							::String msg = ( (::String)(_g1) );
...
HXDLIN( 166)							 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 162)							if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE( 166)								::String msg2 = ( (::String)(_g1) );
