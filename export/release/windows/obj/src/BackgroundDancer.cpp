...
HXDLIN(  12)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(HX_("limo/limoDancer",8e,b6,e5,ea),null());
...
HXLINE(  12)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("limo/limoDancer",8e,b6,e5,ea),library);
HXDLIN(  12)			_hx_tmp = returnAsset;
            		}
