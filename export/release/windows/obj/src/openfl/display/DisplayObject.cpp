...
HXLINE(2279)			 ::openfl::geom::ColorTransform _hx_tmp = this->_hx___objectTransform->_hx___colorTransform;
HXDLIN(2279)			_hx_tmp->_hx___copyFrom(value->get_colorTransform());
