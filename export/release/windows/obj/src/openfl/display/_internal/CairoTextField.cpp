...
HXLINE( 382)										_hx_tmp = ::hx::IsNotNull( end );
            									}
            									else {
...
HXLINE( 395)										{
HXLINE( 395)											int _g = selectionStart;
HXDLIN( 395)											int _g1 = selectionEnd;
HXDLIN( 395)											while((_g < _g1)){
HXLINE( 395)												_g = (_g + 1);
HXDLIN( 395)												int i = (_g - 1);
HXLINE( 396)												selectedGylphs->push(glyphs->__get(i).StaticCast<  ::lime::graphics::cairo::CairoGlyph >());
            											}
            										}
...
HXLINE( 411)							Float x = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 412)							Float y = ((::Math_obj::ceil((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + descent) + ((Float)0.5));
HXLINE( 413)							cairo->moveTo(x,y);
HXLINE( 414)							cairo->lineTo((x + group1->width),y);
...
HXLINE( 421)				_hx_tmp1 = textEngine->selectable;
            			}
            			else {
HXLINE( 421)				_hx_tmp1 = false;
            			}
HXDLIN( 421)			if (_hx_tmp1) {
HXLINE( 421)				_hx_tmp = textField->_hx___showCursor;
            			}
            			else {
HXLINE( 421)				_hx_tmp = false;
            			}
HXDLIN( 421)			if (_hx_tmp) {
HXLINE( 423)				Float scrollX;
HXDLIN( 423)				if (useTextBounds1) {
HXLINE( 423)					scrollX = ( (Float)(0) );
            				}
            				else {
HXLINE( 423)					scrollX = cursorOffsetX;
            				}
HXDLIN( 423)				Float scrollX1 = (-(textField->get_scrollH()) + scrollX);
HXLINE( 424)				Float scrollY = ((Float)0.0);
HXLINE( 426)				{
HXLINE( 426)					int _g = 0;
HXDLIN( 426)					int _g1 = (textField->get_scrollV() - 1);
HXDLIN( 426)					while((_g < _g1)){
HXLINE( 426)						_g = (_g + 1);
HXDLIN( 426)						int i = (_g - 1);
HXLINE( 428)						scrollY = (scrollY + textEngine->lineHeights->get(i));
            					}
            				}
HXLINE( 431)				 ::Dynamic color = textField->get_defaultTextFormat()->color;
HXLINE( 432)				Float r = (( (Float)(::hx::UShr((( (int)(color) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 433)				Float g = (( (Float)(::hx::UShr((( (int)(color) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 434)				Float b = (( (Float)((( (int)(color) ) & 255)) ) / ( (Float)(255) ));
HXLINE( 436)				cairo->setSourceRGB(r,g,b);
HXLINE( 438)				cairo->newPath();
HXLINE( 439)				cairo->moveTo((scrollX1 + ((Float)2.5)),(scrollY + ((Float)2.5)));
HXLINE( 440)				cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 441)				cairo->lineTo((scrollX1 + ((Float)2.5)),((scrollY + ::openfl::text::_internal::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - ( (Float)(1) )));
...
HXLINE( 461)					_hx_tmp1 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE( 461)					_hx_tmp1 = false;
            				}
HXDLIN( 461)				if (_hx_tmp1) {
HXLINE( 461)					_hx_tmp = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN( 461)						int _hx_tmp;
HXDLIN( 461)						bool _hx_tmp1;
HXDLIN( 461)						if (renderer->_hx___allowSmoothing) {
HXLINE( 461)							_hx_tmp1 = bitmap->smoothing;
            						}
            						else {
HXLINE( 461)							_hx_tmp1 = false;
            						}
HXDLIN( 461)						if (_hx_tmp1) {
HXLINE( 461)							_hx_tmp = 1;
            						}
            						else {
HXLINE( 461)							_hx_tmp = 3;
            						}
HXDLIN( 461)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp);
