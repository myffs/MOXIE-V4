...
HXLINE(1063)			 ::openfl::utils::ByteArrayData this1 =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0);
HXDLIN(1063)			this->_hx___data = this1;
HXLINE(1064)			{
HXLINE(1064)				 ::openfl::utils::ByteArrayData this2 = this->_hx___data;
HXDLIN(1064)				this2->writeUTFBytes(::Std_obj::string(data));
            			}
            		}
...
HXLINE(1385)			 ::openfl::utils::ByteArrayData this1 =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0);
HXDLIN(1385)			this->_hx___data = this1;
HXLINE(1386)			{
HXLINE(1386)				 ::openfl::utils::ByteArrayData this2 = this->_hx___data;
HXDLIN(1386)				this2->writeUTFBytes(::Std_obj::string(this->_hx___urlLoader->data));
            			}
            		}
