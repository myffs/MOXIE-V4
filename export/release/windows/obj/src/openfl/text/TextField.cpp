...
HXLINE(2282)			int _hx_tmp = this->getLineOffset(this->getLineIndexOfChar(this->_hx___caretIndex));
HXDLIN(2282)			_hx_tmp1 = (_hx_tmp == this->_hx___caretIndex);
            		}
            		else {
...
HXLINE(2304)					_hx_tmp = (tempScrollH > 0);
            				}
            				else {
...
HXLINE(2316)		bool _hx_tmp2;
HXDLIN(2316)		if ((tempScrollH > 0)) {
HXLINE(2316)			_hx_tmp2 = ::hx::IsNotEq( this->get_type(),1 );
            		}
            		else {
HXLINE(2316)			_hx_tmp2 = false;
            		}
HXDLIN(2316)		if (_hx_tmp2) {
HXLINE(2319)			int lineLength = this->getLineLength(this->getLineIndexOfChar(this->_hx___caretIndex));
HXLINE(2320)			int _hx_tmp = this->get_scrollH();
HXDLIN(2320)			if ((((_hx_tmp + this->get_width()) - ( (Float)(4) )) > lineLength)) {
...
HXLINE(2410)			int _hx_tmp = this->get_scrollH();
HXDLIN(2410)			Float _hx_tmp1 = this->get_mouseX();
HXDLIN(2410)			this->set_scrollH((_hx_tmp + ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min(((_hx_tmp1 - this->get_width()) * ((Float).1)),( (Float)(10) )),( (Float)(1) )))));
            		}
            		else {
HXLINE(2412)			if ((this->get_mouseX() < 1)) {
HXLINE(2414)				int _hx_tmp = this->get_scrollH();
HXDLIN(2414)				this->set_scrollH((_hx_tmp - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseX() * ((Float)-.1)),( (Float)(10) )),( (Float)(1) )))));
            			}
            		}
HXLINE(2417)		this->_hx___mouseScrollVCounter++;
HXLINE(2419)		int _hx_tmp1 = this->_hx___mouseScrollVCounter;
HXDLIN(2419)		if ((_hx_tmp1 > (this->stage->get_frameRate() / ( (Float)(10) )))) {
HXLINE(2421)			Float _hx_tmp = this->get_mouseY();
HXDLIN(2421)			if ((_hx_tmp > (this->get_height() - ( (Float)(2) )))) {
HXLINE(2423)				int _hx_tmp = this->get_scrollV();
HXDLIN(2423)				Float _hx_tmp1 = this->get_mouseY();
HXDLIN(2423)				Float _hx_tmp2 = (_hx_tmp + ::Math_obj::max(::Math_obj::min(((_hx_tmp1 - this->get_height()) * ((Float).03)),( (Float)(5) )),( (Float)(1) )));
HXDLIN(2423)				this->set_scrollV(::Std_obj::_hx_int(::Math_obj::min(_hx_tmp2,( (Float)(this->get_maxScrollV()) ))));
            			}
            			else {
HXLINE(2425)				if ((this->get_mouseY() < 2)) {
HXLINE(2427)					int _hx_tmp = this->get_scrollV();
HXDLIN(2427)					this->set_scrollV((_hx_tmp - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseY() * ((Float)-.03)),( (Float)(5) )),( (Float)(1) )))));
            				}
            			}
...
HXLINE(2905)				_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(2960)					_hx_tmp = ::hx::IsInstanceNotEq( value,this->_hx___styleSheet );
            				}
            				else {
...
HXDLIN(3004)			::cpp::VirtualArray this2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(3004)			this1->__SetField(HX_("__tempIndex",3e,e8,54,22),1,::hx::paccDynamic);
HXDLIN(3004)			{
HXLINE(3004)				int _g_current = 0;
HXDLIN(3004)				::cpp::VirtualArray _g_args = this2;
...
HXDLIN(3253)			bool _hx_tmp2;
HXDLIN(3253)			if (::hx::IsNotEq( this->get_type(),1 )) {
HXLINE(3253)				_hx_tmp2 = this->get_selectable();
            			}
            			else {
HXLINE(3253)				_hx_tmp2 = false;
            			}
HXDLIN(3253)			if (_hx_tmp2) {
HXLINE(3253)				_hx_tmp1 = ::hx::IsNotNull( this->stage );
            			}
            			else {
HXLINE(3253)				_hx_tmp1 = false;
            			}
HXDLIN(3253)			if (_hx_tmp1) {
HXLINE(3253)				_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(3592)					bool _hx_tmp;
HXDLIN(3592)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3592)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3592)						_hx_tmp = false;
            					}
HXDLIN(3592)					if (_hx_tmp) {
HXLINE(3594)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3541)				bool _hx_tmp;
HXDLIN(3541)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3541)					_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3541)					_hx_tmp = false;
            				}
HXDLIN(3541)				if (_hx_tmp) {
...
HXLINE(3567)					_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
...
HXLINE(3552)					_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
...
HXLINE(3419)					_hx_tmp = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
...
HXLINE(3506)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3506)						_hx_tmp = false;
            					}
...
HXLINE(3523)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3523)						_hx_tmp = false;
            					}
...
HXLINE(3455)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
...
HXLINE(3438)					bool _hx_tmp;
HXDLIN(3438)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3438)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3438)						_hx_tmp = false;
            					}
HXDLIN(3438)					if (_hx_tmp) {
...
HXLINE(3472)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
...
HXLINE(3489)						_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
...
HXLINE(3382)					 ::openfl::events::TextEvent te =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
HXLINE(3384)					this->dispatchEvent(te);
HXLINE(3386)					if (!(te->isDefaultPrevented())) {
