...
HXLINE( 968)		 cpp::Int64Struct a = _hx_int64_shr(v,63);
HXDLIN( 968)		sr->d = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct(1))));
HXLINE( 969)		 cpp::Int64Struct a1 = _hx_int64_shr(v,48);
HXDLIN( 969)		sr->q = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct(3))));
HXLINE( 970)		 cpp::Int64Struct a2 = _hx_int64_shr(v,40);
HXDLIN( 970)		sr->itype = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct(15))));
HXLINE( 971)		 cpp::Int64Struct a3 = _hx_int64_shr(v,32);
HXDLIN( 971)		sr->type = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct(15))));
HXLINE( 972)		 cpp::Int64Struct a4 = _hx_int64_shr(v,24);
HXDLIN( 972)		sr->s = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct(255))));
HXLINE( 973)		 cpp::Int64Struct a5 = _hx_int64_shr(v,16);
HXDLIN( 973)		sr->o = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct(255))));
HXLINE( 974)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct(65535))));
