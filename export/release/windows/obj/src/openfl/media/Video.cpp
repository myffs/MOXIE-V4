...
HXDLIN( 307)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,6,6);
HXDLIN( 307)			this->_hx___indexBufferData = this1;
HXLINE( 308)			{
HXLINE( 308)				 ::lime::utils::ArrayBufferView this2 = this->_hx___indexBufferData;
HXDLIN( 308)				 ::__hxcpp_memory_set_ui16(this2->buffer->b,this2->byteOffset,0);
            			}
HXLINE( 309)			{
HXLINE( 309)				 ::lime::utils::ArrayBufferView this3 = this->_hx___indexBufferData;
HXDLIN( 309)				 ::__hxcpp_memory_set_ui16(this3->buffer->b,(this3->byteOffset + 2),1);
            			}
HXLINE( 310)			{
HXLINE( 310)				 ::lime::utils::ArrayBufferView this4 = this->_hx___indexBufferData;
HXDLIN( 310)				 ::__hxcpp_memory_set_ui16(this4->buffer->b,(this4->byteOffset + 4),2);
            			}
HXLINE( 311)			{
HXLINE( 311)				 ::lime::utils::ArrayBufferView this5 = this->_hx___indexBufferData;
HXDLIN( 311)				 ::__hxcpp_memory_set_ui16(this5->buffer->b,(this5->byteOffset + 6),2);
            			}
HXLINE( 312)			{
HXLINE( 312)				 ::lime::utils::ArrayBufferView this6 = this->_hx___indexBufferData;
HXDLIN( 312)				 ::__hxcpp_memory_set_ui16(this6->buffer->b,(this6->byteOffset + 8),1);
            			}
HXLINE( 313)			{
HXLINE( 313)				 ::lime::utils::ArrayBufferView this7 = this->_hx___indexBufferData;
HXDLIN( 313)				 ::__hxcpp_memory_set_ui16(this7->buffer->b,(this7->byteOffset + 10),3);
            			}
...
HXLINE( 359)			Float _hx_tmp = this->_hx___currentWidth;
HXLINE( 357)			_hx_tmp1 = (_hx_tmp != this->get_width());
            		}
            		else {
HXLINE( 357)			_hx_tmp1 = true;
            		}
HXDLIN( 357)		if (!(_hx_tmp1)) {
HXLINE( 360)			Float _hx_tmp1 = this->_hx___currentHeight;
HXLINE( 357)			_hx_tmp = (_hx_tmp1 != this->get_height());
            		}
            		else {
...
HXDLIN( 385)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8);
HXDLIN( 385)			this->_hx___vertexBufferData = this1;
HXLINE( 387)			{
HXLINE( 387)				 ::lime::utils::ArrayBufferView this2 = this->_hx___vertexBufferData;
HXDLIN( 387)				Float val = this->get_width();
HXDLIN( 387)				 ::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            			}
HXLINE( 388)			{
HXLINE( 388)				 ::lime::utils::ArrayBufferView this3 = this->_hx___vertexBufferData;
HXDLIN( 388)				Float val1 = this->get_height();
HXDLIN( 388)				 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 4),val1);
            			}
HXLINE( 389)			{
HXLINE( 389)				 ::lime::utils::ArrayBufferView this4 = this->_hx___vertexBufferData;
HXDLIN( 389)				 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 12),uvWidth);
            			}
HXLINE( 390)			{
HXLINE( 390)				 ::lime::utils::ArrayBufferView this5 = this->_hx___vertexBufferData;
HXDLIN( 390)				 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 16),uvHeight);
            			}
HXLINE( 391)			{
HXLINE( 391)				 ::lime::utils::ArrayBufferView this6 = this->_hx___vertexBufferData;
HXDLIN( 391)				Float val2 = this->get_height();
HXDLIN( 391)				 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 24),val2);
            			}
HXLINE( 392)			{
HXLINE( 392)				 ::lime::utils::ArrayBufferView this7 = this->_hx___vertexBufferData;
HXDLIN( 392)				 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 36),uvHeight);
            			}
HXLINE( 393)			{
HXLINE( 393)				 ::lime::utils::ArrayBufferView this8 = this->_hx___vertexBufferData;
HXDLIN( 393)				Float val3 = this->get_width();
HXDLIN( 393)				 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 40),val3);
            			}
HXLINE( 394)			{
HXLINE( 394)				 ::lime::utils::ArrayBufferView this9 = this->_hx___vertexBufferData;
HXDLIN( 394)				 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + 52),uvWidth);
            			}
...
HXLINE( 418)				_hx_tmp = !(interactiveOnly);
            			}
            			else {
