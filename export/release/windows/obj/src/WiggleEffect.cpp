...
HX_LOCAL_STACK_FRAME(_hx_pos_b9f8e4733e2427ce_35_setValue,"WiggleEffect","setValue",0xb7058861,"WiggleEffect.setValue","WiggleEffect.hx",35,0x20879982)
HX_LOCAL_STACK_FRAME(_hx_pos_b9f8e4733e2427ce_39_set_effectType,"WiggleEffect","set_effectType",0x468e281a,"WiggleEffect.set_effectType","WiggleEffect.hx",39,0x20879982)
HX_LOCAL_STACK_FRAME(_hx_pos_b9f8e4733e2427ce_46_set_waveSpeed,"WiggleEffect","set_waveSpeed",0xb4ea4bbf,"WiggleEffect.set_waveSpeed","WiggleEffect.hx",46,0x20879982)
HX_LOCAL_STACK_FRAME(_hx_pos_b9f8e4733e2427ce_53_set_waveFrequency,"WiggleEffect","set_waveFrequency",0x0e45b2d4,"WiggleEffect.set_waveFrequency","WiggleEffect.hx",53,0x20879982)
HX_LOCAL_STACK_FRAME(_hx_pos_b9f8e4733e2427ce_60_set_waveAmplitude,"WiggleEffect","set_waveAmplitude",0xbc56457b,"WiggleEffect.set_waveAmplitude","WiggleEffect.hx",60,0x20879982)
...
void WiggleEffect_obj::setValue(Float value){
            	HX_STACKFRAME(&_hx_pos_b9f8e4733e2427ce_35_setValue)
HXDLIN(  35)		this->shader->uTime->value[0] = value;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(WiggleEffect_obj,setValue,(void))
 ...
 ::WiggleEffectType WiggleEffect_obj::set_effectType( ::WiggleEffectType v){
            	HX_STACKFRAME(&_hx_pos_b9f8e4733e2427ce_39_set_effectType)
HXLINE(  40)		this->effectType = v;
HXLINE(  41)		::Array< ::String > _hx_tmp = ::Type_obj::getEnumConstructs(::hx::ClassOf< ::WiggleEffectType >());
HXDLIN(  41)		int _hx_tmp1 = _hx_tmp->indexOf(::Std_obj::string(v),null());
HXDLIN(  41)		this->shader->effectType->value = ::Array_obj< int >::__new(1)->init(0,_hx_tmp1);
HXLINE(  42)		return v;
            	}
...
Float WiggleEffect_obj::set_waveSpeed(Float v){
            	HX_STACKFRAME(&_hx_pos_b9f8e4733e2427ce_46_set_waveSpeed)
HXLINE(  47)		this->waveSpeed = v;
HXLINE(  48)		this->shader->uSpeed->value = ::Array_obj< Float >::__new(1)->init(0,this->waveSpeed);
HXLINE(  49)		return v;
            	}
...
Float WiggleEffect_obj::set_waveFrequency(Float v){
            	HX_STACKFRAME(&_hx_pos_b9f8e4733e2427ce_53_set_waveFrequency)
HXLINE(  54)		this->waveFrequency = v;
HXLINE(  55)		this->shader->uFrequency->value = ::Array_obj< Float >::__new(1)->init(0,this->waveFrequency);
HXLINE(  56)		return v;
            	}
...
Float WiggleEffect_obj::set_waveAmplitude(Float v){
            	HX_STACKFRAME(&_hx_pos_b9f8e4733e2427ce_60_set_waveAmplitude)
HXLINE(  61)		this->waveAmplitude = v;
HXLINE(  62)		this->shader->uWaveAmplitude->value = ::Array_obj< Float >::__new(1)->init(0,this->waveAmplitude);
HXLINE(  63)		return v;
            	}
