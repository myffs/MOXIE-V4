...
HXLINE( 360)		if (((cTime - this->oldTime) > ((Float)8.3))) {
...
HXDLIN( 376)							_hx_tmp->setPixels(_hx_tmp1,::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::io::Bytes_obj::ofData(this->bufferMem)));
            					...
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::Dynamic _g = _hx_e;
HXLINE( 384)						 ::haxe::Exception _g1 = ::haxe::Exception_obj::caught(_g);
...
HXLINE( 387)							HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("render broke xd",bd,88,39,4f),null()));
            						}
            						else {
