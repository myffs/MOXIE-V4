...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("v4_installer",87,b6,db,20),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("MyFnf",f2,f9,0a,a6));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("v4_installer",87,b6,db,20));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Vs. Moxie v4",1b,ee,83,d4));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.lildrippymyfnf.moxiev4",14,8f,8e,fd));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.2.7",bd,c1,c9,c1));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Vs. Moxie v4",1b,ee,83,d4))
