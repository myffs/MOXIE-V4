...
HX_DEFINE_STACK_FRAME(_hx_pos_cf8fdd6eb8676a81_262_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","C:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",262,0x60c7a9aa)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_cf8fdd6eb8676a81_262_new)
