...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_536_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",536,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_536_new)
HXLINE( 542)		this->folder = HX_("",00,00,00,00);
HXLINE( 541)		this->color = -7179779;
HXLINE( 540)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 539)		this->week = 0;
HXLINE( 538)		this->songName = HX_("",00,00,00,00);
HXLINE( 546)		this->songName = song;
HXLINE( 547)		this->week = week;
HXLINE( 548)		this->songCharacter = songCharacter;
HXLINE( 549)		this->color = color;
HXLINE( 550)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 551)		if (::hx::IsNull( this->folder )) {
HXLINE( 551)			this->folder = HX_("",00,00,00,00);
            		}
            	}
