...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("v4_installer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("v4_installer", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "v4_installer";
		app.meta["name"] = "Vs. Moxie v4";
		app.meta["packageName"] = "com.lildrippymyfnf.moxiev4";
